...
// Copyright (c) 2013-2014 Massagecoin Developers
...
uint256 hashGenesisBlock("0xc8aeafc802bfa6c2885b32c70ac55f69652025278f585b5df215ab54508da5ea");
...
const string strMessageMagic = "Massagecoin Signed Message:\n";
...
static const int64 nTargetTimespan = 300 * 10; // Massagecoin: every 10 blocks
static const int64 nTargetSpacing = 30; // Massagecoin: 30 second blocks
...
{
        static const int64 BlocksTargetSpacing = 300; // seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Massagecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Massagecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc8aeafc802bfa6c2885b32c70ac55f69652025278f585b5df215ab54508da5ea");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Massagecoin.1399814687.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1399814687; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1077736;

        if (fTestNet)
        {
            block.nTime    = 1399814687;
            block.nNonce   = 1077736;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe5fa1d2f02144a291b24422165583c35ba9153d2e6a91ff7cfddd9c0c0dff5e8"));
...
unsigned char pchMessageStart[4] = { 0xde, 0xfa, 0xce, 0xd0 };
